        ...
        <div class="dashboard_main">
          ...
          <div class="row mt-3">
            <div id="recent-transactions" class="col-12">
              <h4 class="card-title">categorias recem aprovados</h4>
                ...
                <table class="table table-xl mb-0 table-responsive">
                  <thead>
                    <tr>
                      ...
                      <input class="form-check-input" value="" type="checkbox"> Foto </th>
                      <th class="border-top text-capitalize">Nome </th> 
                  ...
                  <?php 
                            ...
                            $CategoriaAdmin =  $Categorias->getLista();                            
                            foreach($CategoriaAdmin as $categoria){
                                ...
                                ?>
                    <tr class="border-bottom categorias-tr<?= $categoria['id'] ?>" >
                        <td class="text-truncate">
                          <div class="form-check">
                            <input class="form-check-input" value="" type="checkbox">
                            <div class="recent_img"> <img src="assets/images/categoria/<?= $categoria['foto']; ?>" alt="Classified Plus" width="100px" height="100px"> </div>
                          </div></td>
                        <td class="text-truncate">
                                  <p><?=$categoria['nome'] ?>.<br>
                            Ad ID: <?=$categoria['id'] ?></p>
                        </td>
                

                        <td>
                                <button type="button" class="btn btn-sm <?php echo $classes ?>"><?= $status ?></button>
                        </td>

                      
                        <td class="text-truncate" >
                            <a href="<?= HOME ?>?page=detalhe-categorias&id=<?= $categoria['id']; ?>">
                            <button type="submit" value="butten">
                            <i class="fa fa-eye"></i>
                            </button>
                            </a>
                            <span>
                                <a href="?page=editar-categorias&id=<?= $categoria['id'] ?>">
                                <button type="submit" value="butten"> 
                            ...
                            <span>
                                <button  value="excluir" name="excluir" >
                                        <i class="fa fa-trash" id="excluir-categoria" onclick="ExcluirCategoria(<?= $categoria['id']; ?>)"></i> 
                                    </button>
                            </span>                   
                        </td>
                    </tr>
